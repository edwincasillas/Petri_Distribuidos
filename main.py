...
def main():
    ...
    # Punto 4
    q, sigma, delta, q0, f, new_bef, finals = generate_sets.generate_afn(bef, START_SYMBOL, END_SYMBOL)
    print("AFN")
    print("q: ", q)
    print("sigma: ", sigma)
    print("delta: ", delta)
    print("q0: ", q0)
    print("f: ", f)
    print("new_bef: ", new_bef)
    make_graphs.dibujar_afn(q, sigma, delta, q0, f)

    q, sigma, delta, q0, f = generate_sets.zip_afn(new_bef, finals, START_SYMBOL, END_SYMBOL)
    print("AFN compacto")
    print("q: ", q)
    print("sigma: ", sigma)
    print("delta: ", delta)
